...
if ($persistentStore.read('request_id') !== null) {
  $notification.post('Vui lòng đóng tập lệnh này', 'Thông tin thu được thành công','')
} else {
  $notification.post('Không thể lấy được thông tin','Vui lòng mở MITM, Chuyển đổi H2 và thêm testflight.apple.com','')
}
$done({})